...
Kukicha transparently generates Go 1.26+ generic type parameters for stdlib functions without requiring users to write generic syntax.
...
func (g *Generator) Generate() (string, error) {
    ...
    g.writeLine("// Generated by Kukicha v0.0.1 (requires Go 1.26+)")
    g.writeLine("//")
...
This ensures that stdlib functions automatically receive proper Go 1.26+ generic type parameters without users needing to write generic syntax in their Kukicha code.
