...
# Utility functions for parsing (can also use standalone)
# Parse boolean value from any string
enabled := env.ParseBool("true") onerr false  # Returns true
debug := env.ParseBool("yes") onerr false     # Returns true
flag := env.ParseBool("1") onerr false        # Returns true

# Split and trim string list
hosts := env.SplitAndTrim("api1.com, api2.com,  api3.com ", ",")
# Returns: ["api1.com", "api2.com", "api3.com"]
...
# ParseBool, SplitAndTrim (utility functions - can be used standalone or internally)
```
